...
const Column = ({ columnId, tasks, onEdit, onDelete, onMove }) => {
  ...
  return (
    <div className="flex-none md:flex-1 min-w-[260px] sm:min-w-[280px] bg-slate-50 rounded-xl border-t-4 border border-slate-200 flex flex-col max-h-[65vh] md:max-h-full">
      <div
        className={`px-3 py-3 border-t-4 -mt-[1px] -mx-[1px] rounded-t-xl ${meta.accent}`}
      >
